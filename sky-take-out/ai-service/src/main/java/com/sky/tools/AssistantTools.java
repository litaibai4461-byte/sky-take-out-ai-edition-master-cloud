...
import com.sky.api.client.StatisticClient;
...
public class AssistantTools {
    ...
    public String getEmployee(){
        List<Employee> employees = userClient.getAll();
    ...
    public String getEmployeeById(Long id){
        Result<Employee> result = userClient.getEmpById(id);
...
//    }
    ...
    public String getOrderSummaryByDate(
        ...
        Result<TurnoverReportVO> result = statisticClient.turnoverStatistics(startDate, endDate);
        TurnoverReportVO turnoverStatistics= result.getData();
